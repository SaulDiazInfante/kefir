...
\graphicspath{{./}{../outputs/neural_sde_comparison_outputs/}{../outputs/all_model_comparison_outputs/}{../neural_sde_comparison_outputs/}{../logistic_pinn_outputs/}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.96\textwidth]{water_kefir_logistic_pinn_comparison.png}
...
transition-likelihood term used to identify $\sigma$.}
\label{fig:logistic-pinn-comparison}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.96\textwidth]{water_kefir_all_models_comparison.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.96\textwidth]{water_kefir_logistic_pinn_losses.png}
...
the \path{kefir-sde-compare} command-line tool, implemented in
\path{src/kefir_models/sde_compare.py}. The deterministic and stochastic
logistic PINN comparison was generated by \path{kefir-logistic-pinn-compare},
...
kefir-plot-all-models \
  --neural-comparison-csv outputs/neural_sde_comparison_outputs/water_kefir_neural_dynamics_comparison.csv \
  --pinn-comparison-csv logistic_pinn_outputs/water_kefir_logistic_pinn_comparison.csv \
  --pinn-dense-csv logistic_pinn_outputs/water_kefir_logistic_pinn_dense.csv \
